  ...
  <div class="table-box">
    ...
    >
      ...
      <template #tableHeader>
        <el-button type="primary" :icon="CirclePlus" @click="openDialog('新增用户')" v-hasPermi="['sys:user:add']">新增用户</el-button>
...
import { CirclePlus, View, EditPen, Delete, Connection, Cpu } from '@element-plus/icons-vue'
